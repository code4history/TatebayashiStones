...
const sharp_path = process.platform === "darwin" ? process.arch === "arm64" ?
    "../system/macm1/sharp" : "../system/mac/sharp" : "../system/win/sharp";
console.log(__dirname);
console.log(__filename);
const sharp_path2 = path.resolve(__dirname, sharp_path);
console.log(sharp_path2);
const ds = fs.readdirSync(sharp_path2);
console.log(ds);

const sharp = require(sharp_path2);
